...
class TableTranslator : public Translator, public Memory, public TranslatorOptions {
   public:
...
class TableTranslation : public Translation {
   ...
   protected:
    ...
    an<DictEntry> PreferredEntry(bool prefer_user_phrase) { return prefer_user_phrase ? uter_.Peek() : iter_.Peek(); }
