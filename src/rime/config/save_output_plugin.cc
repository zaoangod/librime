...
SaveOutputPlugin::SaveOutputPlugin() : resource_resolver_(Service::instance().CreateStagingResourceResolver(kCompiledConfig)) {}

SaveOutputPlugin::~SaveOutputPlugin() {}

bool SaveOutputPlugin::ReviewCompileOutput(ConfigCompiler* compiler, an<ConfigResource> resource) {
    return true;
}
