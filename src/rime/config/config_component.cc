...
ResourceResolver* ConfigResourceProvider::CreateResourceResolver(const ResourceType& resource_type) {
...
ResourceResolver* DeployedConfigResourceProvider::CreateResourceResolver(const ResourceType& resource_type) {
...
ResourceResolver* UserConfigResourceProvider::CreateResourceResolver(const ResourceType& resource_type) {
    return Service::instance().CreateUserSpecificResourceResolver(resource_type);
}

ConfigComponentBase::ConfigComponentBase(ResourceResolver* resource_resolver) : resource_resolver_(resource_resolver) {}
...
an<ConfigData> ConfigLoader::LoadConfig(ResourceResolver* resource_resolver, const string& config_id) {
...
struct MultiplePlugins : ConfigCompilerPlugin {
    ...
    bool ReviewCompileOutput(ConfigCompiler* compiler, an<ConfigResource> resource) override { return ReviewedByAll(&ConfigCompilerPlugin::ReviewCompileOutput, compiler, resource); }
    bool ReviewLinkOutput(ConfigCompiler* compiler, an<ConfigResource> resource) override { return ReviewedByAll(&ConfigCompilerPlugin::ReviewLinkOutput, compiler, resource); }
...
template <class Container>
bool MultiplePlugins<Container>::ReviewedByAll(Reviewer reviewer, ConfigCompiler* compiler, an<ConfigResource> resource) {
...
an<ConfigData> ConfigBuilder::LoadConfig(ResourceResolver* resource_resolver, const string& config_id) {
