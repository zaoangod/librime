...
size_t ConfigData::ResolveListIndex(an<ConfigItem> item, const string& key, bool read_only) {
...
an<ConfigItemRef> TraverseCopyOnWrite(an<ConfigItemRef> head, const string& node_path) {
