...
void StringTable::CommonPrefixMatch(const string& query, vector<StringId>* result) {
    marisa::Agent agent;
...
void StringTableBuilder::Add(const string& key, double weight, StringId* reference) {
