...
CustomSettings::CustomSettings(Deployer* deployer, const string& config_id, const string& generator_id) : deployer_(deployer), config_id_(config_id), generator_id_(generator_id) {}
...
bool CustomSettings::Load() {
    ...
    path custom_config_path = deployer_->user_data_dir / custom_config_file(config_id_);
